    ...
    <section className="py-10 md:py-14 border-t border-gray-100 dark:border-gray-800">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {stats.map((stat, index) => (
          <div key={index} className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 md:p-5">
            <p className="text-2xl md:text-3xl font-semibold text-primary-600 tracking-tight">
              {stat.number}
            </p>
