...
export default function TrustBar() {
  return (
    <div className="border-y border-gray-100 dark:border-gray-800 py-3 md:py-4 overflow-x-auto">
      <div className="flex items-center gap-4 min-w-max md:min-w-0">
        
        {/* Left label */}
        <span className="hidden sm:block flex-shrink-0 text-xs text-gray-400 whitespace-nowrap">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <div className="hidden sm:inline-flex items-center gap-1.5 rounded-full border border-gray-200 dark:border-gray-700 px-3 py-1.5 text-xs text-gray-600 dark:text-gray-400">
