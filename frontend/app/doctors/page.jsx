                ...
                {doctors.map(doctor => (
                  <div key={doctor._id} className="bg-white dark:bg-dark-card rounded-[2rem] border-0 shadow-sm p-8 flex flex-col hover:shadow-md transition-all group">
                    <div className="flex items-start gap-5 mb-6">
                      ...
                      <div>
                        <h3 className="font-bold text-gray-900 dark:text-dark-text-primary text-lg line-clamp-1 group-hover:text-primary-500 transition-colors">Dr. {doctor.user?.name}</h3>
                        <p className="text-sm text-primary-600 dark:text-primary-400 font-bold mt-0.5">{doctor.specialization}</p>
                        <div className="flex items-center gap-1.5 mt-2 text-sm text-gray-600 dark:text-dark-text-secondary bg-dark-bg dark:bg-dark-sidebar/50 px-2 py-0.5 rounded-lg w-fit">
