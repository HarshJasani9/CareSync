  ...
  return (
    <div className="min-h-screen bg-surface-muted flex flex-col font-sans selection:bg-primary-500 selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-black text-gray-900 tracking-tight">Care<span className="text-primary-600">Link</span></span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div className="max-w-2xl">
              ...
              <h1 className="text-5xl lg:text-7xl font-black text-gray-900 leading-[1.1] mb-6 tracking-tight text-balance">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link 
                  href="#features" 
                  className="px-8 py-4 bg-white text-gray-900 font-bold rounded-2xl border-2 border-gray-100 hover:border-gray-200 hover:bg-gray-50 transition-all duration-300 flex items-center justify-center"
                >
                  Learn More
                </Link>
              </div>
              ...
              {/* Trust badges */}
              <div className="mt-10 flex items-center gap-6 pt-10 border-t border-gray-200/60">
                <div className="flex -space-x-4">
                  {[...Array(4)].map((_, i) => (
                    <div key={i} className={`w-10 h-10 rounded-full border-2 border-white bg-gray-${(i+2)*100} flex items-center justify-center text-sm font-bold shadow-sm overflow-hidden`}>
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-gray-900">Trusted by thousands of patients</p>
                </div>
              </div>
            </div>
            ...
            <div className="relative lg:h-[600px] flex items-center justify-center">
              ...
              {/* Floating Cards */}
              <div className="absolute top-10 -left-6 bg-white p-4 rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 z-20 flex items-center gap-3 animate-float">
                <div className="w-10 h-10 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" /></svg>
                </div>
                <div>
                  <p className="text-sm font-bold text-gray-900">Appointment Confirmed</p>
                  <p className="text-xs text-gray-500">Dr. Sarah Jenkins • Tomorrow, 10:00 AM</p>
                </div>
              </div>
              
              <div className="absolute bottom-10 -right-6 bg-white p-4 rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 z-20 flex items-center gap-3 animate-float animation-delay-2000">
                <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                </div>
                <div>
                  <p className="text-sm font-bold text-gray-900">New Prescription</p>
      ...
      <section className="py-24 bg-gray-900 relative overflow-hidden">
        ...
        <div className="absolute -top-24 -right-24 w-96 h-96 bg-primary-500 rounded-full mix-blend-screen filter blur-3xl opacity-30"></div>
...
function FeatureCard({ icon, title, description, color, bgColor }) {
  return (
    <div className="group p-8 rounded-3xl bg-white border-2 border-gray-50 hover:border-primary-100 hover:shadow-2xl hover:shadow-primary-500/10 transition-all duration-300 hover:-translate-y-2">
